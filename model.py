...
def getEvents(zipcode, category, key):
    query = f"https://app.ticketmaster.com/discovery/v2/events.json?apikey={key}&postalCode={zipcode}&classificationName={category}"
